...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-primary/10 to-secondary/10 border-t mt-16">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Logo e Descrição */}
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-10 h-10 earth-gradient rounded-xl flex items-center justify-center shadow-lg">
                <Quote className="w-5 h-5 text-white" />
              </div>
              <span className="font-bold text-2xl text-white earth-gradient bg-clip-text">
                ParaFrase
              </span>
            </div>
