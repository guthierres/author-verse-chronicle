...
  // 🛑 Mantenha todos os hooks no topo, sempre
...
  useEffect(() => {
    // Busque os dados apenas quando o usuário e as permissões estiverem prontos
    if (!authLoading && isAdmin) {
      fetchAllData();
    }
  }, [authLoading, isAdmin]); // Inclua as dependências para re-executar

  // 🛑 Realize a renderização condicional APENAS após os hooks
  if (authLoading) {
    return (
